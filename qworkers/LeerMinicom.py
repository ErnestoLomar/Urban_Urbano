            ...
            if len(viajes) > 0:
                for viaje in viajes:
                    try:
                        ...
                        estado_servidor_fin = viaje[9]

                        trama_4 = "4,"+str(folio_de_viaje)+","+str(hora_inicio)+","+str(csn_chofer)+","+str(total_de_folio_aforo_efectivo)+","+str(total_de_folio_aforo_tarjeta)+","+str(total_aforo_efectivo)
